...
class TestEveryFunction(unittest.TestCase):
    ...
    def test_seconds(self):
        ...
        self.assertAlmostEqual(start_time + self.interval_in_seconds * self.count_max,
                               end_time, delta=0.1)
    ...
    def test_start_at_after(self):
        ...
        expected_end_time = (start_time +
                             self.interval_in_seconds * self.count_max -
                             self.interval_in_seconds + after_in_seconds)
